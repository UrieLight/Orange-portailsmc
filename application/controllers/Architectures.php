<?php 
	...
	/*
	* Controlleur des architectures
	*/

	class Architectures extends CI_Controller{
		
		public $root_path = '../..';
		public $title = 'Architectures des services';
		...
		public function view(){
			...
			$this->load->view('architectures', $data);
		...
		public function architectures_display(){
