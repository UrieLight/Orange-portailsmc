...
<!-- ================ 	CONTENU DE LA PAGE DE MODIFICATION DES ARCHITECTURES ================	-->
...
<div class="content_bloc container-fluid">
	...
	<div class="content_header">
		...
		<div class="content_title"><h2> Architectures des services <span class="badge" title="<?= $nbr_architectures; ?> Architectures enregistrées">(<?= $nbr_architectures; ?>)</span></h2></div>
